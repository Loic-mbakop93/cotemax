...
const BM_META = {
  // African / local bookmakers — link directly to their football section
  '1xbet':      { name: '1xBet',        url: 'https://1xbet.cm/en/line/football' },
  onexbet:      { name: '1xBet',        url: 'https://1xbet.cm/en/line/football' },
  betway:       { name: 'Betway',       url: 'https://betway.cm/sports/football' },
  bet365:       { name: 'Bet365',       url: 'https://www.bet365.com/sport/football' },
  melbet:       { name: 'Melbet',       url: 'https://melbet.cm/en/line/football' },
  paripesa:     { name: 'Paripesa',     url: 'https://paripesa.cm/sports/soccer' },
  betpawa:      { name: 'betPawa',      url: 'https://www.betpawa.cm/events?sportId=1&categoryId=2&marketId=1X2' },
  betwinner:    { name: 'BetWinner',    url: 'https://betwinner.cm/en/line/football' },
  premierbet:   { name: 'premierBet',   url: 'https://www.premierbet.cm/sports/football' },
  linebet:      { name: 'Linebet',      url: 'https://linebet.cm/en/sports/football' },
  betandyou:    { name: 'Betandyou',    url: 'https://betandyou.cm/en/sports/football' },
  megapari:     { name: 'Megapari',     url: 'https://megapari.cm/en/sports/football' },
  // International bookmakers
  pinnacle:     { name: 'Pinnacle',     url: 'https://www.pinnacle.com/en/soccer/matchups' },
  williamhill:  { name: 'William Hill', url: 'https://sports.williamhill.com/betting/en-gb/football' },
  unibet_fr:    { name: 'Unibet',       url: 'https://www.unibet.fr/sport/football' },
  marathonbet:  { name: 'Marathonbet',  url: 'https://www.marathonbet.com/en/sports/football' },
  betclic_fr:   { name: 'Betclic',      url: 'https://www.betclic.fr/football-s1' },
  winamax_fr:   { name: 'Winamax',      url: 'https://www.winamax.fr/paris-sportifs/sports/1' },
  betsson:      { name: 'Betsson',      url: 'https://www.betsson.com/en/sportsbook/football' },
  betfair_ex_eu:{ name: 'Betfair',      url: 'https://www.betfair.com/sport/football' },
  matchbook:    { name: 'Matchbook',    url: 'https://www.matchbook.com/sport/football' },
  nordicbet:    { name: 'NordicBet',    url: 'https://www.nordicbet.com/en/sports/football' },
  leovegas_se:  { name: 'LeoVegas',     url: 'https://www.leovegas.com/en-gb/sports/football' },
  coolbet:      { name: 'Coolbet',      url: 'https://www.coolbet.com/en/sports/football' },
  tipico_de:    { name: 'Tipico',       url: 'https://www.tipico.com/en/soccer' },
}
